...
│   ├── company-research/    # Company research dossiers + article saves — subfolder per company: [slug]/[slug].md (dossier), [slug]/MMDDYY-article-*.md (articles from /act)
│   ├── industry-research/   # Industry landscape analyses (generated by /research-industry); also article saves from /act when no primary company is identified
