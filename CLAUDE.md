...
│   ├── job-todos-daily-log.md # Daily progress log (generated by /job-todos daily)
...
- **Researching companies:** Run `/research-company "Company Name" [url] [context]` for a deep dossier with conversation starters
