...
**Good:**
> During this session you described running the technical evaluation that closed a $2M enterprise deal at Northwind. Your Northwind project file doesn't mention that in key achievements. You also talked about using Salesforce deal data to build the win/loss program there, which isn't in the technology list. Want me to add both?
