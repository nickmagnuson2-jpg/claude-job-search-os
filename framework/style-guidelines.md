...
Casual register is achieved through *voice* (contractions, conversational rhythm, parenthetical asides, looser scaffolding, lower-formality vocabulary) — **never** through lowercase-everything styling. Lowercase-everything is a tech-Twitter / Gen-Z aesthetic Nick is not in; it reads as performatively casual, which is the opposite of authentic casual.

When dialing register *down* from formal toward casual, change these: contraction use up, sentence scaffolding cut ("Quick update:" / "I wanted to reach out about..."), conversational asides allowed, vocabulary lower-register. Do **not** change capitalization, basic punctuation, or paragraph breaks. The rule holds even when matching a recipient who writes lowercase — Nick's voice doesn't.

Origin: a LinkedIn DM draft. Nick explicit: *"Use proper capitalization, and I want to just make it known that even casual writings do not mean lowercase."* See `memory/feedback_casual_register_proper_capitalization.md`.
...
### CEO/founder post-call follow-up (canonical exemplar)

When drafting a thank-you / momentum note to a **founder or CEO** after a substantive call, the four failure modes below are non-obvious and recur. Full guidance + verbatim exemplar: **voice-reference.md → Exemplar 5**. The short form:

1. **Never grade their own decision back to them** ("X is the right answer/way"). Go a level deeper — name the mechanism it unlocks, as a peer-level claim.
2. **No AI abstraction-preamble** ("A few things stuck with me, the one I keep coming back to..."). Lead straight into the specific thing.
3. **Callback posture = peer, not student.** "I came in with a question, your framing answered it, that really resonated" — not "it made it click for me."
4. **Preference framing + deferential close.** "the part of X I cared about most" / "Looking forward to hopefully hearing from <coordinator> on potential next steps soon" — not "what I'm best at" / "Let me know the next step" (and softer than even "next steps with <coordinator>"). Refinement (3rd touch): a warm forward-looking line ("Looking forward to meeting in person!"), NOT an over-hedged tag ("No rush, whenever is convenient" — Nick cut exactly that). Deferential ≠ hedgy. Promoted after 2nd occurrence (two separate founder follow-ups).
5. **Subject = plain-warm, not the clever hook.** "Thanks for today" — never the body's specific synthesized phrase ("the circle you drew"). Earned in the body, performed in the subject. Nick's subject voice is functional, not a line he's proud of.

Origin: a founder post-call follow-up (5 Nick-directed passes). Rules in `memory/lessons.md` Section 2.

### In-person texture in post-meeting openers

When drafting a post-meeting follow-up (thank-you, momentum note, debrief reply) after Nick met the recipient in person, add **in-person texture details** to the opener before the substantive callback. Texture means small concrete details that signal Nick actually showed up and noticed: commute energy, office vibe, "seeing HQ in person," "the room," the case being enjoyable, "came away excited." These details are what Claude tends to skip as "too small to mention" — and exactly what makes the opener land as a Nick-voice thank-you rather than a templated one.

Do **not** stack texture (one or two details, not a list). Do **not** invent texture Nick didn't experience. The detail must be sourceable from Nick's actual visit — usually you'll have it from the call transcript, the prior context, or Nick's inline notes after the call.

Origin: one founder follow-up added an opener with case enjoyment + office + commute + "came away excited"; a second send-time edit added "seeing HQ in person" (2nd occurrence, same shape). Promoted from `memory/lessons.md` Section 2 (Occurrences=2).
