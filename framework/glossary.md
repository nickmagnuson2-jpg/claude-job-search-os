...
| **disposition** | — | **Method sense:** how an unknown is being handled. **Warning:** this word also has a domain sense in the client's data, and that collision reached a client page. Never use it unqualified in an audience-facing artifact | this file |
